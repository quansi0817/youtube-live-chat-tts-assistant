    ...
    function scrapeMessage(element) {
        try {
            ...
            const messageSelectors = [
                ...
                'yt-live-chat-paid-message-renderer #content-text'
            ];
            ...
            if (!messageContent) {
                ...
                cloned.querySelectorAll('#author-name, #timestamp, #header-subtext, #header-author-name, yt-live-chat-author-chip, #author-photo').forEach(n => n.remove());
